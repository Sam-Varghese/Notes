# <div style='text-align:center'><span style='color:gold;font-family:Georgia;font-size:2em'>Python Basics Notes
...
## <div style='text-align:center'><span style='color:blue;font-family:Georgia;font-size:2em'>Tokens
...
### <span style='color:yellow;font-family:Georgia;font-size:2em'>Keywords
...
> ### <span style='color:cyan;font-family:georgia;font-size:1.5em'>Operators
...
> #### <span style='color:cyan;font-family:georgia;font-size:1.5em'>Operators Precedence Order
...
> ### <span style='color:cyan;font-family:georgia;font-size:1.5em'>Punctuators
...
### <span style='color:blue;font-family:Georgia;font-size:2em'>Conditional branching
...
### <span style='color:blue;font-family:Georgia;font-size:2em'>Loops

 Python has two primitive loop commands:
1. while loops
2. for loops

#### <span style='color:gold;font-family:Georgia;font-size:2em'>While Loop
...
#### <span style='color:gold;font-family:Georgia;font-size:2em'>For Loop
...
>>  file_handle.close()
>>  ````
>>  * #### <span style='color:blue;font-family:Georgia;font-size:2em'>Readline
>>  
